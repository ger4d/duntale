...
/**
 * Immutable data snapshot for the {@link DuntaleScoreboard} HUD.
 *
 * <p>Built via the {@link Builder} pattern. All fields have sensible defaults.
 */
public final class DuntaleScoreboardData {
    ...
    private DuntaleScoreboardData(@Nonnull Builder builder) {
    ...
    /**
     * Builder for {@link DuntaleScoreboardData}.
     */
    public static final class Builder {
        ...
        @Nonnull
        public DuntaleScoreboardData build() {
            return new DuntaleScoreboardData(this);
        }
    }
}
