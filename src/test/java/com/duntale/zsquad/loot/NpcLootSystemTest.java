...
class NpcLootSystemTest {
    ...
    class ResolveAttackerUuid {
        ...
        void shouldCreditDirectPlayerAttacker() {
            ...
            UUID result = AttackerResolver.resolveAttackerUuid(true, playerUuid, null);
        ...
        void shouldReturnNullForPlayerMissingUuid() {
            UUID result = AttackerResolver.resolveAttackerUuid(true, null, null);
        ...
        void shouldCreditCompanionKillToOwner() {
            ...
            UUID result = AttackerResolver.resolveAttackerUuid(false, null, ownerUuid);
        ...
        void shouldReturnNullForUnrelatedNpcAttacker() {
            UUID result = AttackerResolver.resolveAttackerUuid(false, null, null);
